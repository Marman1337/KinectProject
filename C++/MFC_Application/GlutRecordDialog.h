...
class CGlutRecordDialog : public CDialogEx
{

public:
	CGlutRecordDialog(CWnd* pParent = NULL);   // standard constructor
	virtual ~CGlutRecordDialog();

// Dialog Data
	enum { IDD = IDD_GLUT_RECORD_DIALOG };

protected:
	virtual void DoDataExchange(CDataExchange* pDX);    // DDX/DDV support
	virtual BOOL CGlutRecordDialog::OnInitDialog();

...
\noindent
To test for the possibility that obstructions could interfere with the fitting of the skeleton on the subject, we place a chair in various positions around the subject and in front of the subject. We then do the same with another person walking in the vicinity of the subject. The selection of these scenarios was based on the fact that they are relevant to situations which may be encountered in a dance class room, where a dancer may lift or dance around an object or next to another student.  
\subsubsection{Chair}
...
\begin{figure}
\center
\includegraphics[scale=0.507]{SlowEnd.jpg} \includegraphics[scale=0.5]{FastEnd.jpg}

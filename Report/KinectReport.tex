...
\begin{itemize}
\item{Sometimes signals aligned in some places and misaligned in others.}
\item{Velocity gives absurd results sometimes.}
\item{Torso automatically has a higher weighting.}
\item{Need for windowing.}
\end{itemize}
